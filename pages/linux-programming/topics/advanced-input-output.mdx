...
### Homework
   - [FS-4: Redirect standard input](/linux-programming/tasks/file-systems/redirect-cin/)
   - [FS-5: Manaul append](/linux-programming/tasks/file-systems/manual-append/)
   - [FS-10: Copy a file accounting holes](/linux-programming/tasks/file-systems/copy-with-holes/)

### Samples
   - [Redirect standard output and error](/linux-programming/samples/redirect-output/)
   - [Create a file with holes](/linux-programming/samples/make-hole/)
   - [Detect holes in the file](/linux-programming/samples/detect-holes/)
