...
description: "A C++ solution to the dining philosophers problem using semaphores, with a deadlock-prone naive version and an odd/even fix."
---
...
int main(int argc, char** argv){
    ...
    for(int i = 0; i < count; ++i){
        ...
        // initialize semaphores to 1 (fork is available)
...
If all the philosophers simultaneously pick up the **left** fork, they will succeed, however, no philosopher will be able to pick up the right fork, and hence, no one will eat and put down the left fork.
