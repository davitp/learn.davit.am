...
description: "Implement a C++ shared_array class that shares an integer array between processes by name and size, with operator[] access and semaphore synchronization."
---
