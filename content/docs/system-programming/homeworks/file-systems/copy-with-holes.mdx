---
title: "FS-10: Copy a file with holes"
description: "Copy a file in C++ on Linux while preserving its holes (sparse regions), overwriting the destination and reporting data and hole byte counts."
---
