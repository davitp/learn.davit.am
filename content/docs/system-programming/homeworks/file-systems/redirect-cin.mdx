...
description: "Redirect a program's standard input to read from a file instead of the keyboard, without changing its std::cin or scanf calls."
---
...
- Implement a simple logic for `main()` function to read string from the standard input (std::cin) and print the reversed string to the console (std::cout).
