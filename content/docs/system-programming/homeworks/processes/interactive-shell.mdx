...
description: "Build an interactive C++ shell that spawns a process per command, adds the current directory to PATH, and redirects 'silent' commands to a PID.log file."
---
