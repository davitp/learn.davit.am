...
description: "Build a C++ parallel_scheduler thread pool with a fixed capacity, enqueue functions for execution, and ship it as a shared library with a demo app."
---
