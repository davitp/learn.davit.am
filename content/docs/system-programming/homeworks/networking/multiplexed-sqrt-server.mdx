---
title: "NET-2: Multiplexed Sqrt Server"
description: "Build a non-blocking multiplexed TCP server in C/C++ using epoll that returns sqrt(abs(x)) for 4-byte integers from many simultaneous clients."
---
